      ...
      <DialogContent className="sm:max-w-[425px] bg-gradient-to-br from-[#111] to-[#151515] border border-gray-600 shadow-xl">
        <DialogHeader className="pb-3">
          <div className="flex items-center mb-3">
            ...
            <DialogTitle className="text-xl font-bold text-white">서브도메인 {project?.sub_domain ? '수정' : '등록'}</DialogTitle>
          </div>
          <DialogDescription className="text-gray-400 mt-2">
            프로젝트의 서브도메인을 설정하여 딥링크를 활성화하세요.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 py-5">
          ...
          <DialogFooter className="pt-5 mt-6">
            ...
            >
              ...
              ) : project?.sub_domain ? '서브도메인 수정하기' : '서브도메인 등록하기'}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
